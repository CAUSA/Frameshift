				...
				for(int i2=0;i2<4;i2++){
					...
					for(int i3=0;i3<4;i3++){
						...
						for(int i4=0;i4<4;i4++)
						{
							...
							//System.out.print(codon1+' '+Tr(codon1,code)+"<=>");							
							//System.out.println(codon2+' '+Tr(codon2,code));
							int Score;
							if(Sc(Tr(codon1,code))=='*'||Sc(Tr(codon2,code))=='*')
									{
								Score=0;
									}
							else
							{
								Score=ScoringMatrix[Sc(Tr(codon1,code))][Sc(Tr(codon2,code))];
							}
						...
						for(int i5=0;i5<4;i5++)
						{
							...
							//System.out.print(codon1+' '+Tr(codon1,code)+"<=>");							
							//System.out.print(codon2+' '+Tr(codon2,code));
							int Score1;
							if(Sc(Tr(codon1,code))=='*'||Sc(Tr(codon2,code))=='*')
									{
								Score1=0;
							...
							{
								int IndexOfAA1=Sc(Tr(codon1,code));
								int IndexOfAA2=Sc(Tr(codon2,code));
