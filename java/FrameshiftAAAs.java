/*
==============================================================
FrameshiftAAAs - java version 1.0.001 

Usage: FrameshiftAAAs 
=============================================================
	...
	for ( i=1;i<=4;i++){
		...
		for ( j=1;j<=4;j++){
			...
			for (k=1;k<=4;k++){
				...
				AA1=FrameshiftAAAs.translate(codon);
				NoCodon++;
