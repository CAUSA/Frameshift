public class RandomCodeBlossum {
	...
	public static void main(String[] args) 
	{
		...
		int tag=socall[NumCodes];
		System.out.println("end");
		for(int e=0;e<NumCodes;e++)
			for(int f=e+1;f<NumCodes+1;f++)
			{
				int temp;
		...
		for(int g=0;g<NumCodes+1;g++)
			if(socall[g]==tag)
			{   
				System.out.print("本来编码方式的排列位数：");
				System.out.print(g+1);
				System.out.print("/");
				System.out.print(NumCodes);
				break;
			}
	}
