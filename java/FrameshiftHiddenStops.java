/*
==============================================================
FrameshiftHiddenStops - java version 1.0.001 

Usage: FrameshiftHiddenStops 
=============================================================
...
import java.io.*;
import java.util.*;
public class FrameshiftHiddenStops {
	...
	//Preparing the scoring matrix Gon250
		...
		System.out.println("NHiddenStops-Positive");
		System.out.println("NHiddenStops-Negative");
...
//	Forward Shifting
	...
	for ( i=1;i<=4;i++){
		...
		for ( j=1;j<=4;j++){
			...
			for (k=1;k<=4;k++){
				...
				AA1=FrameshiftHiddenStops.translate(codon);
				NoCodon++;
				...
				for (s=1;s<=4;s++){
				   codon2=codon.substring(1,codon.length());
					if (s==1){ codon2+="A";}
					    ...
					    AA2=FrameshiftHiddenStops.translate(codon2);
					    AA3=FrameshiftHiddenStops.translatereadthrough(codon2);
		        		AA1No=allAAs.indexOf(AA1)+1;
		        		AA2No=allAAs.indexOf(AA3)+1;
						float SScore=ScoreMatrix[AA1No][AA2No];
						NumFS++;
						SumScore+= SScore;
					if (AA2.equals("*")){
						HiddenStops++;
						System.out.println(String.valueOf(HiddenStops)+" "+ codon+" "+AA1 +"--> "+codon2+" "+AA2+" "+AA3+" "+String.valueOf(SScore));
					}
					else {
						if (SScore>=0) {NHiddenStops1++;} else {NHiddenStops2++;}
					}
				}
			}
		}
	...
	System.out.println(String.valueOf(NHiddenStops1));
	System.out.println(String.valueOf(NHiddenStops2));
	System.out.println(String.valueOf(HiddenStops));
...
//	Backward Shifting
	...
	System.out.println("\n\n Calculated SUCCESS!\n");
            ...
            System.out.println("\n Usage: java FrameshiftHiddenStops");
