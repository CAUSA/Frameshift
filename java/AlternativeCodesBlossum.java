...
public class AlternativeCodesBlossum {
						...
						for(int i2=0;i2<4;i2++){
							...
							for(int i3=0;i3<4;i3++){
								...
								for(int i4=0;i4<4;i4++)
								{
									...
									if(i4==2){b[0]="C";}
									if(i4==3){b[0]="G";}
									String test1=a[0]+a[1]+a[2];
									String test2=b[0]+b[1]+b[2];
									//System.out.print(test1+" "+Translate(test1,code,aa)+"|");							
									//System.out.println(test2+" "+Translate(test2,code,aa));
									int Score;
									Score=ScoringMatrix[MatrixIndex(Translate(test1,code,aa))][MatrixIndex(Translate(test2,code,aa))];
								...
								for(int i5=0;i5<4;i5++)
								{
									...
									if(i5==3){c[2]="G";}
									String test1=a[0]+a[1]+a[2];
									String test2=c[0]+c[1]+c[2];
									//System.out.print(test1+" "+Translate(test1,code,aa)+"|");							
									//System.out.println(test2+" "+Translate(test2,code,aa));
									int Score1;
									Score1=ScoringMatrix[MatrixIndex(Translate(test1,code,aa))][MatrixIndex(Translate(test2,code,aa))];
