...
//Preparing the scoring matrix Gon250
	...
	for  (int seqNo=1;seqNo<=TotalSeq;seqNo++){
		...
		for (int Frame=1;Frame<=2;Frame++){
			...
			String output=args[0]+"Frame-"+Frame+".Pro.blastp.txt";
			...
			String exe= "blastp -query=" + input + " -db Ecoli_db" + " -out " + output + " -outfmt 6 qseqid sseqid qstart qend sstart send qlen slen length pident evalue bitscore qcovs";
