...
public class RandomCodesGonnet {
	...
	public static void main(String[] args) 
	{
		...
		//input is the user-defined number of codes to compute
				...
				for(int i2=0;i2<4;i2++){
					...
					for(int i3=0;i3<4;i3++){
						...
						for(int i4=0;i4<4;i4++)
						{
							...
							//System.out.print(codon1+" "+Translate(codon1,code)+"<=>");							
							//System.out.print(codon2+" "+Translate(codon2,code));
							int Score;
							int IndexOfAA1=MatrixIndex(Translate(codon1,code));
							int IndexOfAA2=MatrixIndex(Translate(codon2,code));
							//System.out.print(",Index: ");
							//System.out.print(IndexOfAA1);
							//System.out.print(", ");
							//System.out.print(IndexOfAA2);
							Score=ScoringMatrix[IndexOfAA1][IndexOfAA2];
						...
						for(int i5=0;i5<4;i5++)
						{
							...
							//System.out.print(", ");
							//System.out.print(IndexOfAA2);
							Score1=ScoringMatrix[IndexOfAA1][IndexOfAA2];
							//System.out.print(" FSS= ");
