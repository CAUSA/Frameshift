/*
==============================================================
FrameshiftToAAAs - java version 1.0.001 

Usage: FrameshiftToAAAs 
=============================================================
...
public class FrameshiftToAAAs {
	...
	//Preparing the scoring matrix Gon250
		...
		System.out.println("NAAAs-Positive");
		System.out.println("NAAAs-Negative");
...
//	Forward Shifting
	...
	for ( i=1;i<=4;i++){
		...
		for ( j=1;j<=4;j++){
			...
			for (k=1;k<=4;k++){
				...
				AA1=FrameshiftToAAAs.translate(codon);
				NoCodon++;
				...
				for (s=1;s<=4;s++){
				   codon2=codon.substring(1,codon.length());
					if (s==1){ codon2+="A";}
					    ...
					    AA2=FrameshiftToAAAs.translate(codon2);
		        		AA1No=allAAs.indexOf(AA1)+1;
		        		AA2No=allAAs.indexOf(AA2)+1;
						float SScore=ScoreMatrix[AA1No][AA2No];
						NumFS++;
						SumScore+= SScore;
					if ("HCDRE".indexOf(AA2)>=0){
						AAAs++;
						System.out.println(String.valueOf(AAAs)+" "+ codon+" "+AA1 +"-->"+codon2+" "+AA2+" "+String.valueOf(SScore));
					}
					else {
						if (SScore>=0) {NAAAs1++;} else {NAAAs2++;}
					}
				}
			}
		}
	...
	System.out.println(String.valueOf(NAAAs1));
	System.out.println(String.valueOf(NAAAs2));
	System.out.println(String.valueOf(AAAs));
