...
public static void main(String args[])
{
	try
	{
		...
		System.out.println("\n Usage: SubScore<Path> <CDS file> <[readthrough=]Yes/No> <[SeqType=]Frameshift/Random> <CLUSTALW/MSA/No> \n"); 
		...
		//SubScoreType: Frameshift or Random
		...
		else
		{
	 	...
	 	String SubScoreFile = path + "/" + CDSfile + "." + ReadThrough + "." + Aligner+"."+SeqType+".Similarities.txt"; 
	...
	//Compute SubScore
	 ...
	 // Preparing Output file
		...
		BufferedWriter out = new BufferedWriter(new FileWriter(SubScoreFile)); 
		...
		{ 
			...
			double [][]SubScore= new double [4][4]; 	 
			double MeanSubScore= 0.0; 	
			...
			{	 				
				for (j = i+1; j <= 3; j++)
				{
					...
					System.out.print("Comparing frame " + i + " vs " + j ); 
					System.out.print("\n"); 
					
					System.out.print("Site\tAA1\tAA2\tFSS"); 
					...
					for (int Pos = 0; Pos < AlnLen; Pos++)
					{
						...
						System.out.print("\t"); 
						System.out.print(String.valueOf(FSS)); 
						System.out.print("\n"); 
					}
					
					SubScore[i][j] = (double) FSS;
		...
		System.out.println("\t Results saved in file:\t"+SubScoreFile+"\n"); 
