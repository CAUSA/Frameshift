/*
==============================================================
PseudoAAindexAlternativeCodesFrameshiftCorrelation123.java version 3.0.001 
...
public class PseudoAAindexAlternativeCodesFrameshiftCorrelation123{

public static void main(String[] args) throws Exception 
{
	
	System.out.println("\n Produce alternative genetic codes, calculate the mean square difference of their AA indices upon frameshifting, and the rank of the natural genetic code. The AA indices is in file ./Matrix/AAindex1.txt or ./Matrix/FakeAAindex1.txt"); 
	...
	{
		System.out.println("\n Wrong parameter!"); 
		System.out.println("\n Usage: java -cp ./ PseudoAAindexAlternativeCodesFrameshiftCorrelation123 <Output>"); //
		System.out.println("\n Output: whether or not to output the scores for each genetic code:  "); 
		System.out.println("\t\t\tOutput=Y-Output all MS values; \n\t\t\tOutput=nCodes-not to output MS values. "); 
		System.exit(0); 
	}

	String Output=args[0];
		
	//Reading the AA indices in file  
	...
	//int nSM = AAindex.readAAidx(iNum, iName, iAAs, iMat);   //Real AA index: ./Matrix/AAindex1.txt 
	int nSM = AAindex.readFakeAAidx(iNum, iName, iAAs, iMat); //Fake AA index: ./Matrix/FakeAAindex.txt
	...
	for (int s=1; s<=nSM; s++)
	{
		...
		if (Output.toUpperCase().indexOf("Y")>=0)
		{
			String MSfile="./AGCs-Normal-"+String.valueOf(s)+"-MSm-MSf.txt";					
