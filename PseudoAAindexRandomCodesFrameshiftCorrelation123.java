/*
==============================================================
PseudoAAindexRandomCodesFrameshiftCorrelation123.java version 2.1.001 
...
public static void main(String[] args) throws Exception
{
	...
	for (int s=Start; s<=End; s++)
	{
		...
		{
			String MSfile="./Plot/data/normalMS/RGCs-Normal-"+String.valueOf(s)+"-MSm-MSf.txt";					
